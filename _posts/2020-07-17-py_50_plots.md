...
excerpt: "共同学习，边看边学。本文列举了50个最有价值的数据可视化图表，帮助您通过matplotlib和seaborn更加高效地呈现数据。"
read_time: false
header:
  overlay_image: /assets/images/py_50_plt_03_scatter_with_linear_regression_line_of_best_fit.png
  overlay_filter: 0.5
  teaser: /assets/images/py_50_plt_03_scatter_with_linear_regression_line_of_best_fit.png
  actions:
    - label: "查看原文"
...
目前Charlie只尝试了其中部分代码，但是由于文章质量非常高，所以Charlie决定转载过来一起学习。欢迎一起试一试，和Charlie一起讨论。
{: .notice--info}

一个有价值的图标应当满足以下几个条件：

* 在不歪曲事实的条件下传达准确且必要的信息；
* 设计简单，容易阅读；
* 用设计美学辅助数据，而不是掩盖信息；
* 承载信息适量，不过度饱和。
...
全文根据数据可视化的 7 个不同目的进行分组。如果要描绘 2 个变量之间的关系，请查看"关联"部分下的绘图。或者您想要显示值如何随着时间而变化，请查看"更改"部分。您可已通过右侧的导航快速切换到相应的位置。

# 准备工作

在运行具体的绘图代码之前，您需要将以下代码先运行一次。但有些绘图代码会重新定义其中的部分模块。
...
关联部分的图表用于可视化 2 个或更多变量之间的关系。换句话说，显示一个变量是如何改变另一个变量的。

## 1.散点图 Scatter plot

散点图是用于研究两个变量之间关系的经典基础图表。如果数据中有多个组，则可能需要以不同的颜色可视化每个组。在matplotlib中，您可以使用plt.scatterplot()方便地执行此操作。

![py_50_plt_01_scatter](/assets/images/py_50_plt_01_scatter.png)
...
有时，您想在边界内显示一组点以强调其重要性。在此示例中，您从应该环绕的数据框中获取记录，并用encircle()来使边界显示出来。

![py_50_plt_02_bubble_with_eccircling](/assets/images/py_50_plt_02_bubble_with_eccircling.png)
...
![py_50_plt_03_scatter_with_linear_regression_line_of_best_fit](/assets/images/py_50_plt_03_scatter_with_linear_regression_line_of_best_fit.png)
...
![py_50_plt_03_scatter_with_linear_regression_line_of_best_fit_2](/assets/images/py_50_plt_03_scatter_with_linear_regression_line_of_best_fit_2.png)
...
![py_50_plt_04_jittering_with_stripplot](/assets/images/py_50_plt_04_jittering_with_stripplot.png)
...
![py_50_plt_05_counts_plot](/assets/images/py_50_plt_05_counts_plot.png)
...
![py_50_plt_06_marginal_histogram](/assets/images/py_50_plt_06_marginal_histogram.png)
...
![py_50_plt_07_marginal_boxplot](/assets/images/py_50_plt_07_marginal_boxplot.png)
...
![py_50_plt_08_correllogram](/assets/images/py_50_plt_08_correllogram.png)
...
![py_50_plt_09_pairwise_plot](/assets/images/py_50_plt_09_pairwise_plot.png)
...
![py_50_plt_09_pairwise_plot_2](/assets/images/py_50_plt_09_pairwise_plot_2.png)
...
![py_50_plt_10_diverging_bars](/assets/images/py_50_plt_10_diverging_bars.png)
...
![py_50_plt_11_diverging_texts](/assets/images/py_50_plt_11_diverging_texts.png)
...
![py_50_plt_12_diverging_dot_plot](/assets/images/py_50_plt_12_diverging_dot_plot.png)
...
![py_50_plt_13_diverging_lollipop_chart_with_markers](/assets/images/py_50_plt_13_diverging_lollipop_chart_with_markers.png)
...
![py_50_plt_14_area_chart](/assets/images/py_50_plt_14_area_chart.png)
...
![py_50_plt_15_ordered_bar_chart](/assets/images/py_50_plt_15_ordered_bar_chart.png)
...
![py_50_plt_16_lollopop_chart](/assets/images/py_50_plt_16_lollopop_chart.png)
...
![py_50_plt_17_dot_plot](/assets/images/py_50_plt_17_dot_plot.png)
...
![py_50_plt_18_slope_plot](/assets/images/py_50_plt_18_slope_plot.png)
...
![py_50_plt_19_dumbell_plot](/assets/images/py_50_plt_19_dumbell_plot.png)
...
![py_50_plt_20_histogram_for_continuous_variable](/assets/images/py_50_plt_20_histogram_for_continuous_variable.png)
...
![py_50_plt_21_histogram_for_categorucal_variable](/assets/images/py_50_plt_21_histogram_for_categorucal_variable.png)
...
![py_50_plt_22_density_plot](/assets/images/py_50_plt_22_density_plot.png)
...
![py_50_plt_23_density_curves_with_histogram](/assets/images/py_50_plt_23_density_curves_with_histogram.png)
...
![py_50_plt_24_joy_plot](/assets/images/py_50_plt_24_joy_plot.png)
...
![py_50_plt_25_distributed_dot_plot](/assets/images/py_50_plt_25_distributed_dot_plot.png)
...
![py_50_plt_26_box_plot](/assets/images/py_50_plt_26_box_plot.png)
...
![py_50_plt_27_dot_n_box_plot](/assets/images/py_50_plt_27_dot_n_box_plot.png)
...
![py_50_plt_28_violin_plot](/assets/images/py_50_plt_28_violin_plot.png)
...
![py_50_plt_29_population_pyramid](/assets/images/py_50_plt_29_population_pyramid.png)
...
![py_50_plt_30_categorical_plots](/assets/images/py_50_plt_30_categorical_plots.png)
...
![py_50_plt_30_categorical_plots_2](/assets/images/py_50_plt_30_categorical_plots_2.png)
...
![py_50_plt_31_waffle_chart](/assets/images/py_50_plt_31_waffle_chart.png)
...
![py_50_plt_31_waffle_chart_2](/assets/images/py_50_plt_31_waffle_chart_2.png)
...
![py_50_plt_32_pie_chart](/assets/images/py_50_plt_32_pie_chart.png)
...
![py_50_plt_32_pie_chart_2](/assets/images/py_50_plt_32_pie_chart_2.png)
...
![py_50_plt_33_treemap](/assets/images/py_50_plt_33_treemap.png)
...
![py_50_plt_34_bar_chart](/assets/images/py_50_plt_34_bar_chart.png)
...
![py_50_plt_35_time_series_plot](/assets/images/py_50_plt_35_time_series_plot.png)
...
![py_50_plt_36_time_series_with_peaks_n_troughs_annotated](/assets/images/py_50_plt_36_time_series_with_peaks_n_troughs_annotated.png)
...
![py_50_plt_37_autocorrelationn](/assets/images/py_50_plt_37_autocorrelationn.png)
...
![py_50_plt_38_cross_correlation_plot](/assets/images/py_50_plt_38_cross_correlation_plot.png)
...
![py_50_plt_39_time_series_decomposition_plot](/assets/images/py_50_plt_39_time_series_decomposition_plot.png)
...
![py_50_plt_40_multiple_time_series](/assets/images/py_50_plt_40_multiple_time_series.png)
...
![py_50_plt_41_second_y_axis](/assets/images/py_50_plt_41_second_y_axis.png)
...
![py_50_plt_42_time_series_with_error_bands](/assets/images/py_50_plt_42_time_series_with_error_bands.png)
...
![py_50_plt_42_time_series_with_error_bands_2](/assets/images/py_50_plt_42_time_series_with_error_bands_2.png)
...
![py_50_plt_43_stacked_area_chart](/assets/images/py_50_plt_43_stacked_area_chart.png)
...
![py_50_plt_44_area_chart_unstacked](/assets/images/py_50_plt_44_area_chart_unstacked.png)
...
![py_50_plt_45_calander_heat_map](/assets/images/py_50_plt_45_calander_heat_map.png)
...
![py_50_plt_46_sesasonal_plot](/assets/images/py_50_plt_46_sesasonal_plot.png)
...
![py_50_plt_47_dendrogram](/assets/images/py_50_plt_47_dendrogram.png)
...
![py_50_plt_48_cluster_plot](/assets/images/py_50_plt_48_cluster_plot.png)
...
![py_50_plt_49_andrews_curve](/assets/images/py_50_plt_49_andrews_curve.png)
...
![py_50_plt_50_parallel_coordinates](/assets/images/py_50_plt_50_parallel_coordinates.png)
