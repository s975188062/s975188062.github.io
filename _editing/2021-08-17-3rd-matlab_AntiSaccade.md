---
title: "PsychToolBox 脚本讲解 - AntiSaccade.m"
...
此脚本来源于**本地示例文件夹**中的 `EyeLink_SimplePicture.m`，如果您已经安装 `2.2.1` 版本的  `Eyelink Development Kit`，您可以在 “./Psychtoolbox/PsychHardware/EyelinkToolbox/EyelinkDemos/SR-ResearchDemo/AntiSaccade” 中找到它。
{: .notice--info}
